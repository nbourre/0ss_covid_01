    ...
    public class CustomersDataService : IDataService<Customer>
    {
        ...
        public CustomersDataService()
        {
            customers = new List<Customer>()
            {
                ...
                new Customer() {Name="Clinton", LastName="Galla",Address="Ap #150-7450 Sapien Rd.", City="Scarborough",Province="ON", PostalCode="M5V 7N1", PicturePath="images/user.png", ContactInfo="Home : 328-524-0475"},
